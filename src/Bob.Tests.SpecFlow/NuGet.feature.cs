...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Creating npgsql package from template")]
        public virtual void CreatingNpgsqlPackageFromTemplate()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating npgsql package from template", ((string[])(null)));
#line 80
 this.ScenarioSetup(scenarioInfo);
#line 82
     testRunner.Given("there is npgsql repository cloned into \"D:/Projects/npgsql\" directory", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line hidden
            ...
            table11.AddRow(new string[] {
                        "})"});
#line 108
        testRunner.When("I execute the following task", ((string)(null)), table11, "When ");
#line hidden
...
#line 124
  testRunner.Then("the following process is being executed", ((string)(null)), table12, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
